...
class Snake:
    ...
    def control(self, event):
        if event.type == pygame.KEYDOWN:
            if event.key == pygame.K_w and self.dir[pygame.K_w] or not (self.dir[pygame.K_s] and (self.dir[pygame.K_a] or self.dir[pygame.K_d])):
                self.direction = vec2(0, -self.size)
                self.dir = {pygame.K_w: 1, pygame.K_s: 0, pygame.K_a: 1, pygame.K_d: 1}
            if event.key == pygame.K_s and self.dir[pygame.K_s] or not (self.dir[pygame.K_w] and (self.dir[pygame.K_a] or self.dir[pygame.K_d])):
                self.direction = vec2(0, self.size)
                self.dir = {pygame.K_w: 0, pygame.K_s: 1, pygame.K_a: 1, pygame.K_d: 1}
            if event.key == pygame.K_a and self.dir[pygame.K_a] or not (self.dir[pygame.K_d] and (self.dir[pygame.K_w] or self.dir[pygame.K_s])):
                self.direction = vec2(-self.size, 0)
                self.dir = {pygame.K_w: 1, pygame.K_s: 1, pygame.K_a: 1, pygame.K_d: 0}
            if event.key == pygame.K_d and self.dir[pygame.K_d] or not (self.dir[pygame.K_a] and (self.dir[pygame.K_w] or self.dir[pygame.K_s])):
                self.direction = vec2(self.size, 0)
